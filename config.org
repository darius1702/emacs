...
*** Misc
Settings that don't fit the other categories
...
*** Keybindings
Text editing keybinds and related settings
...
All kinds of whitespace, auto-pairs, editorconfig, narrowing, ...
...
(use-package elfeed
  ...
  :config
  (setq-default elfeed-search-filter "@6-months")
