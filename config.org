...
(defun darius/pick-theme ()
  ...
  (let* ((themes '(("catppuccin-light" . darius/catppuccin-load-light)
                   ...
                   ("standard-dark" . (lambda () (standard-themes-select 'standard-dark)))
                   ("standard-dark-tinted" . (lambda () (standard-themes-select 'standard-dark-tinted)))
                   ("standard-light" . (lambda () (standard-themes-select 'standard-light)))
                   ("standard-light-tinted" . (lambda () (standard-themes-select 'standard-light-tinted)))))
