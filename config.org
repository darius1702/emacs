...
(use-package tex
  ...
  ;; otherwise we get errors because of package load order
  (with-eval-after-load 'latex
    (keymap-set LaTeX-mode-map "C-c C-r" #'reftex-reference)
    (keymap-set LaTeX-mode-map "C-M-i" #'complete-symbol)))
