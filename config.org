...
(defvar-local darius/mode-line-read-only-indicator
  '(:eval
    (when buffer-read-only
      (if (mode-line-window-selected-p)
          (propertize " %%" 'face 'darius/mode-line-highlight)
        " %%"))))
...
#+begin_src emacs-lisp
;; (add-to-list 'default-frame-alist '(alpha-background . 98)) ; some transparency
#+end_src

*** Modus themes (built-in)
[[https://protesilaos.com/emacs/modus-themes#h:6c1d1dea-5cbf-4d92-b7bb-570a7a23ffe9][Modus themes]]
