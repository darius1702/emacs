...
(use-package modus-catppuccin
  ...
  (catppuccin-mocha-palette-overrides
   '((base  "#1c1c1e")
     ...
     (bg-mode-line-active       surface1)
     (border-mode-line-active   overlay2)
     (fg-mode-line-inactive     subtext0)
     (bg-mode-line-inactive     base)
     (border-mode-line-inactive surface1)
...
(with-eval-after-load 'verilog-mode
  (keymap-set verilog-mode-map "C-;" #'darius/switch-buffer-or-delete-window))
#+end_src
...
(keymap-global-set "C-S-p" #'darius/move-line-up)
(keymap-global-set "C-S-n" #'darius/move-line-down)
#+end_src
