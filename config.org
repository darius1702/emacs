...
I usually build my emacs with the following flags
~./configure --with-native-compilation=aot --with-tree-sitter --with-x-toolkit=lucid --with-imagemagick --without-compress-install --disable-gc-mark-trace --enable-link-time-optimization 'CFLAGS=-O3 -march=native -mtune=native'~
...
(defun darius/set-up-fonts ()
  (set-face-attribute 'default nil :font darius/fixed-pitch-font :height 130 :weight 'regular :width 'regular)
  (set-face-attribute 'variable-pitch nil :font darius/variable-pitch-font :height 1.0 :weight 'regular :width 'regular)
  (set-face-attribute 'fixed-pitch nil :font darius/fixed-pitch-font :height 1.0 :weight 'regular :width 'regular))
...
(use-package catppuccin-theme
  ...
  (catppuccin-set-color 'surface0 "#121216")
  (catppuccin-set-color 'surface1 "#202127")
  (catppuccin-set-color 'surface2 "#252532")
  (catppuccin-reload)
...
(setq treesit-font-lock-level 4)           ; 4 works well with catppuccin
