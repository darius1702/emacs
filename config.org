...
(defun darius/ir-black-theme ()
  (interactive)
  (use-package ir-black-theme
    :config
    (mapc 'disable-theme custom-enabled-themes)
    (load-theme 'ir-black t)
    (set-face-attribute 'mode-line-inactive nil :foreground "grey65")
    (set-face-attribute 'org-block nil :foreground "white")
    (set-face-attribute 'org-block nil :background "grey6")
    (set-face-attribute 'org-block-begin-line nil :background "grey8")
    (set-face-attribute 'org-block-end-line nil :background "grey8")))
...
(defun darius/catppuccin-theme-setup ()
  (interactive)
  (mapc #'disable-theme custom-enabled-themes)
