...
(global-set-key (kbd "M-v") (lambda () (interactive) (darius/scroll-down 0.5)))
(global-set-key (kbd "C-v") (lambda () (interactive) (darius/scroll-up 0.5)))
...
#+begin_src emacs-lisp
(setq darius/fixed-pitch-font "Iosevka Comfy Fixed")
(setq darius/variable-pitch-font "Iosevka Comfy Fixed")
...
#+begin_src emacs-lisp
(require 'f) ; otherwise org-roam doesn't find `f-join'
(use-package org-roam
  :config
  (setq org-roam-directory (f-join org-directory "org-roam"))
