...
#+begin_src emacs-lisp
(setq frame-title-format '("%b")) ; otherwise the window title also has the "GNU Emacs at $hostname" part
...
(setopt ispell-dictionary "en_US"
        ...
        ispell-alternate-dictionary "/usr/share/dict/words") ;; NOTE this needs extra/words on arch
...
(setopt crm-prompt "[%d (%s)] %p")      ; make `completing-read-multiple' prompt show the separator
...
Some colorschemes probably override the colors
