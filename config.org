...
;; window layout history, see `tab-bar-history-mode'
;; (winner-mode 1)
#+end_src
...
(defun darius/switch-buffer-or-delete-other-windows (arg)
  "Call `switch-to-buffer' or `delete-other-window'/`tab-bar-history-back' if called with one/two C-u presses"
  (interactive "P")
  (cond
   ((null arg)
...
(use-package copilot
  ...
  (:map copilot-completion-map
        ("C-c C-i C-i" . copilot-accept-completion)
        ("C-c C-i C-l" . copilot-accept-completion-by-line)
        ("C-c C-i C-w" . copilot-accept-completion-by-word)
        ("C-c C-i C-n" . copilot-next-completion)
        ("C-c C-i C-p" . copilot-previous-completion)
        ("C-c C-i C-o" . copilot-panel-complete)))
