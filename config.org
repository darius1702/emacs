...
(use-package catppuccin-theme
  ...
  (defun darius/catppuccin-face-setup ()
    ...
    (set-face-attribute 'mode-line-inactive nil :box `(:line-width -1 :color ,(catppuccin-color 'surface1)))
...
*** COMMENT Custom load-theme prompt
For modus-themes there's ~modus-themes-select~

#+begin_src emacs-lisp
(defun darius/load-theme ()
  (interactive)
  (let* ((themes '(("catppuccin-light" . darius/catppuccin-load-light)
                   ("catppuccin-dark" . darius/catppuccin-load-dark)
                   ("modus-operandi" . (lambda () (modus-themes-select 'modus-operandi)))
                   ("modus-vivendi" . (lambda () (modus-themes-select 'modus-vivendi)))
                   ("modus-operandi-tinted" . (lambda () (modus-themes-select 'modus-operandi-tinted)))
                   ("modus-vivendi-tinted" . (lambda () (modus-themes-select 'modus-vivendi-tinted)))))
